...
DROP_ITEMS = {
    # Low tier materials
    'goblin_ear': {'name': 'Goblin Ear', 'type': 'material', 'sell_value': 5, 'description': 'A gross goblin ear'},
    'bone': {'name': 'Bone Fragment', 'type': 'material', 'sell_value': 8, 'description': 'A brittle bone fragment'},
    'healing_herb': {'name': 'Healing Herb', 'type': 'consumable', 'heal': 20, 'sell_value': 8, 'description': 'A medicinal herb'},
    'iron_ore': {'name': 'Iron Ore', 'type': 'material', 'sell_value': 12, 'description': 'Raw iron ore'},
    'spider_silk': {'name': 'Spider Silk', 'type': 'material', 'sell_value': 10, 'description': 'Gleaming spider silk'},
    'wolf_pelt': {'name': 'Wolf Pelt', 'type': 'material', 'sell_value': 12, 'description': 'A soft wolf pelt'},
    
    # Mid tier materials
    'orc_tusk': {'name': 'Orc Tusk', 'type': 'material', 'sell_value': 15, 'description': 'A sharp orc tusk'},
    'bandit_mask': {'name': 'Bandit Mask', 'type': 'material', 'sell_value': 20, 'description': 'A tattered bandit mask'},
    'cursed_bone': {'name': 'Cursed Bone', 'type': 'material', 'sell_value': 25, 'description': 'A dark, cursed bone'},
    'bandit_coin': {'name': 'Bandit Coin', 'type': 'material', 'sell_value': 30, 'description': 'A coin from a bandit hoard'},
    'silver_ore': {'name': 'Silver Ore', 'type': 'material', 'sell_value': 25, 'description': 'Precious silver ore'},
    'shadow_essence': {'name': 'Shadow Essence', 'type': 'material', 'sell_value': 30, 'description': 'Dark energy from the shadows'},
    'crystal_shard': {'name': 'Crystal Shard', 'type': 'material', 'sell_value': 35, 'description': 'A glowing crystal fragment'},
    
    # High tier materials
    'troll_hide': {'name': 'Troll Hide', 'type': 'material', 'sell_value': 40, 'description': 'Tough troll hide'},
    'mithril_ore': {'name': 'Mithril Ore', 'type': 'material', 'sell_value': 50, 'description': 'Rare mithril ore'},
    'demon_horn': {'name': 'Demon Horn', 'type': 'material', 'sell_value': 60, 'description': 'A twisted demon horn'},
    'ancient_relic': {'name': 'Ancient Relic', 'type': 'material', 'sell_value': 75, 'description': 'A mysterious ancient artifact'},
    
    # Legendary materials
    'dragon_scale': {'name': 'Dragon Scale', 'type': 'material', 'sell_value': 100, 'description': 'A shimmering dragon scale'},
    'phoenix_feather': {'name': 'Phoenix Feather', 'type': 'material', 'sell_value': 150, 'description': 'A feather of eternal flame'},
    'star_fragment': {'name': 'Star Fragment', 'type': 'material', 'sell_value': 200, 'description': 'A piece of fallen starlight'},
    'void_crystal': {'name': 'Void Crystal', 'type': 'material', 'sell_value': 250, 'description': 'Pure void energy crystallized'},
    
    # Consumables
    'mana_potion': {'name': 'Mana Potion', 'type': 'consumable', 'heal': 0, 'sell_value': 30, 'description': 'Restores magical energy'},
    'energy_crystal': {'name': 'Energy Crystal', 'type': 'consumable', 'heal': 40, 'sell_value': 20, 'description': 'A crystal that heals when consumed'},
    
    # Tower-specific loot
    'tower_shard': {'name': 'Tower Shard', 'type': 'material', 'sell_value': 50, 'description': 'A fragment from the Tower'},
    'tower_core': {'name': 'Tower Core', 'type': 'material', 'sell_value': 150, 'description': 'The core essence of a Tower floor'},
    'ethereal_gem': {'name': 'Ethereal Gem', 'type': 'material', 'sell_value': 100, 'description': 'A gem that phases between dimensions'},
